...
import { useDropdown } from '../../../hooks/src/useSelect/useDropdown';
import { useFilter } from '../../../hooks/src/useSelect/useFilter';
...
export var ComboBoxField = function (_a) {
    ...
    var _d = useSelect({
        options: hasEmptyOption ? __spread([{ name: emptyOptionText, value: undefined }], options) : __spread(options),
    ...
    var _f = __read(useState(isLoading), 2), _isLoading = _f[0], setIsLoading = _f[1];
    useEffect(function () {
